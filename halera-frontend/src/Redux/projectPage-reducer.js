...
let initialState = {
   projectData:{
       ...
       searchTeam: true,
       members:[
           {position: 'Frontend', userName:'dog', profileImage:member, name: 'Julia Sitka'},
           {position: 'Backend', userName:'useless', profileImage:member, name: 'Pavlo Andrushko'},
           {position: 'Designer', userName:'ira', profileImage:member, name: 'Ira Gricik'},
           {position: 'TeamLead', userName:'maxnomad', profileImage:member, name: 'Max Guminenko'},
           {position: 'IOS', userName:'olehcon', profileImage:member, name: 'Oleh Kononenko'}
       ],

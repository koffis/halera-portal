    ...
    return(<div>
           {/*MAINLOGO*/}
            <div className="mainBanner">
                <div className="revealator_slideup mainText">HALERA
                    <div className="revealator_slideup revealator_delay1">
                        <p>Found dalbayobs in the world. Yaroslav gandon</p>
                ...
                <div className="clouds">
                    <img src={cloud1} className="animate1"></img>
                    <img src={cloud2} className="animate2"></img>
                    <img src={cloud3} className="animate3"></img>
                    <img src={cloud4} className="animate4"></img>
                    <img src={cloud5} className="animate5"></img>
                </div>
        </div>
            {/*MAINCONTENT*/}
            <div className="maincontent">
                <div className="container text-center">
                    <div className="revealator_slideup revealator_once revealator_delay1">
